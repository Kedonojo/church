...
<body>
  ...
  <div id="wrapper" class="wrapper-container page-full-height">
    ...
    <header id="header" class="header style-2 type-2">
      ...
      <div class="top-header">
        ...
        <div class="header-btns">
          ...
          <!-- button -->
          <div class="head-btn">
            <a href="#" class="btn btn-big btn-style-5">Give <span>Online</span></a>
          </div>
    ...
    <div id="content" class="page-content-wrap coming-soon">
      ...
      <div class="container">
        ...
        <div class="align-center">
          ...
          <div class="content-element3">
            ...
            <p class="text-size-big">Our website is under construction. We`ll be here soon with our </p>
    
          </div>
    
          <div>
            <div class="countdown" data-year="2018" data-month="12" data-day="16" data-hours="15" data-minutes="0" data-seconds="0"></div>
          </div>
    ...
    <footer id="footer" class="footer">
      ...
      <div class="copyright">
        ...
        <p>Copyright © 2018 <a href="#">Churhius</a>. All Rights Reserved.</p>
