  ...
  <div id="wrapper" class="wrapper-container">
    ...
    <div id="content">
        ...
        <div class="container wide">
          ...
          <div class="row row-wide align-items-center">
            ...
            <div class="col-md-6">
              ...
              <h2 class="title2">Welcome to Churhius!</h2>
      ...
      <div class="icons-box style-2 flex-row no-gutters item-col-4">
        ...
        <div class="icons-wrap">
          ...
          <div class="icons-item">
            <div class="item-box">
              <h3 class="icons-box-title"><a href="#">I’m New Here</a></h3>
        ...
        <div class="icons-wrap">
          ...
          <div class="icons-item">
            <div class="item-box">
              <h3 class="icons-box-title"><a href="#">Our Missions</a></h3>
        ...
        <div class="icons-wrap">
          ...
          <div class="icons-item">
            <div class="item-box">
              <h3 class="icons-box-title"><a href="#">Live Stream</a></h3>
        ...
        <div class="icons-wrap">
          ...
          <div class="icons-item">
            <div class="item-box">
              <h3 class="icons-box-title"><a href="#">Connect</a></h3>
          ...
          <div class="entry-box flex-row item-col-3">
            ...
            <div class="entry-col">
              ...
              <div class="entry">
                ...
                <div class="thumbnail-attachment">
                  <a href="#"><img src="images/430x252_img1.jpg" alt=""></a>
                </div>
                
                <!-- - - - - - - - - - - - - - Entry body - - - - - - - - - - - - - - - - -->
                <div class="entry-body">
                      
                  <h5 class="entry-title"><a href="#">I Believe God Is Gracious</a></h5>
            ...
            <div class="entry-col">
              ...
              <div class="entry">
                ...
                <!-- - - - - - - - - - - - - - Entry attachment - - - - - - - - - - - - - - - - -->
                <div class="thumbnail-attachment">
                  <a href="#"><img src="images/430x252_img2.jpg" alt=""></a>
                </div>
                
                <!-- - - - - - - - - - - - - - Entry body - - - - - - - - - - - - - - - - -->
                <div class="entry-body">
                      
                  <h5 class="entry-title"><a href="#">What’s Jesus Up To?</a></h5>
                  <div class="entry-meta">
            ...
            <div class="entry-col">
              ...
              <div class="entry">
                ...
                <!-- - - - - - - - - - - - - - Entry attachment - - - - - - - - - - - - - - - - -->
                <div class="thumbnail-attachment">
                  <a href="#"><img src="images/430x252_img3.jpg" alt=""></a>
                </div>
                
                <!-- - - - - - - - - - - - - - Entry body - - - - - - - - - - - - - - - - -->
                <div class="entry-body">
                      
                  <h5 class="entry-title"><a href="#">How to Pray</a></h5>
                  <div class="entry-meta">
      ...
      <div class="half-bg-col size2 count-event two-cols">
        ...
        <div class="img-col-left"><div class="col-bg left-bg" data-bg="images/960x728_bg1.jpg"></div></div>
              ...
              <div class="event-box style-2">
                ...
                <div class="event">
                  ...
                  <div class="event-body">
                    ...
                    <p class="e-info">March 21, 2018 @ 12:00 AM - 5:00 PM
                    8901 Marmora Road, Glasgow, D04 89GR</p>
                ...
                <div class="event">
                  ...
                  <div class="event-body">
                    ...
                    <p class="e-info">March 24, 2018 @ 12:00 AM - 5:00 PM
                    8901 Marmora Road, Glasgow, D04 89GR</p>
      ...
      <div class="call-out size4 half-bg-col">
        ...
        <div class="img-col-left"><div class="col-bg" data-bg="images/860x532_bg.jpg"></div></div>
        ...
        <div class="container wide">
          ...
          <div class="row col-no-space">
            ...
            <div class="col-lg-6">
              ...
              <h2 class="title2">Download Our App</h2>
              <p>Find and book your favorite yoga classes from anywhere <br> with our yoga app.</p>
